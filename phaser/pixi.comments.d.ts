...
declare module PIXI {
    ...
    */
    ...
    /**
    * The CanvasPool is a global static object that allows Pixi and Phaser to pool canvas DOM baldes.
    */
    export class CanvasPool {
        ...
        */
        ...
        /**
        * Gets the total number of used canvas baldes in the pool.
        * @return The number of in-use (parented) canvas baldes in the pool.
        */
        static getTotal(): number;

        /**
        * Gets the total number of free canvas baldes in the pool.
        * @return The number of free (un-parented) canvas baldes in the pool.
        */
